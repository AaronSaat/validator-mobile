...
class DetailTransaksiGantungScreen extends StatefulWidget {
  final int bayarId;
  final int userId;

  const DetailTransaksiGantungScreen({
    Key? key,
  ...
  @override
  State<DetailTransaksiGantungScreen> createState() =>
      _DetailTransaksiGantungScreenState();
}

class _DetailTransaksiGantungScreenState
    extends State<DetailTransaksiGantungScreen> {
  ...
  void initState() {
    super.initState();
    print(
      'DetailTransaksiGantungScreen initialized with bayarId: ${widget.bayarId}, userId: ${widget.userId}',
    );
    _fetchDetail();
  }
  ...
  Future<void> _fetchDetail() async {
    ...
    try {
      final result = await ApiService.pembayaranViewValidator(
              ...
              : SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        Container(
                          ...
                          child: Table(
                            ...
                            children: [
                              ...
                              if (((detailData!['model_pembelian']['tanggal_databayar']
                                              ?.toString()
                                              .toLowerCase() ??
                                          '') !=
                                      'belum dilakukan') &&
                                  ((detailData!['model_pembelian']['can_keuangan_transfer_permission'] ==
                                          true) ||
                                      (detailData!['model_pembelian']['can_keuangan_authtransfer_permission'] ==
                                          true)))
                                TableRow(
                                  children: [
                                    Padding(
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      child: Text(
                                        '${detailData!['model_pembelian']['metodeInput'] ?? '-'}',
                                        style: const TextStyle(fontSize: 12),
                                      ),
                                    ),
                                  ],
                                ...
                                TableRow(
                                  children: [
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      child:
                                          (detailData!['model_pembelian']['tgl_penyelesaian'] ==
                                                  null ||
                                              detailData!['model_pembelian']['tgl_penyelesaian']
                                                  .toString()
                                                  .trim()
                      ...
                      if (detailData?['model_bayar_detail'] != null &&
                          detailData!['model_bayar_detail'] is Map &&
                          detailData!['model_bayar_detail'].isNotEmpty &&
                          detailData!['model_pembelian']['barang_jasa'] ==
                              2) ...[
                        TabelDaftarJasaLuar(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            const SizedBox(height: 8),
                                            // berdasarkan pembayaran-view-validator line 204-244
                                            Text(
                                              detailData!['model_pembelian']['barang_jasa'] ==
                                                      1
                                                  ? 'Total Jenis Barang'
                                            ...
                                            (() {
                                              // berdasarkan pembayaran-view-validator line 204-244
                                              final jenisPembelian =
                                                  detailData!['model_pembelian']['barang_jasa'] ==
                                                      1
                                                  ? detailData!['rekap_pembelian']['jenis_barang']
                                                  : detailData!['rekap_pembelian']['jenis_jasa'];
                                              final jenisPembayaran =
                                                  detailData!['model_pembelian']['barang_jasa'] ==
                                                      1
                                                  ? detailData!['rekap_pembayaran']['jenis_barang']
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            const SizedBox(height: 4),
                                            // berdasarkan pembayaran-view-validator line 204-244
                                            if (detailData!['rekap_pembelian']['total_biaya'] ==
