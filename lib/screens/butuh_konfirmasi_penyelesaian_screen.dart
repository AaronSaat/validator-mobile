            ...
            child: Column(
              children: [
                if (isLoading)
                  ...
                  butuhKonfirmasiPenyelesaianList.isEmpty
                  ...
                  Expanded(
                    child: (butuhKonfirmasiPenyelesaianList.isEmpty)
                        ? Center(
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: const Text(
                                    'Tidak ada data butuh konfirmasi penyelesaian',
                                    style: TextStyle(
                                      color: AppColors.textblack,
                                      fontSize: 16,
                                      fontWeight: FontWeight.bold,
                                ...
                                SizedBox(
                                  ...
                                  child: Material(
                                    ...
                                    child: InkWell(
                                      borderRadius: BorderRadius.circular(8),
                                      onTap: _fetchButuhKonfirmasiPenyelesaian,
                                      child: Row(
                                        mainAxisAlignment:
                                            MainAxisAlignment.center,
                                        children: const [
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              final item =
                                  butuhKonfirmasiPenyelesaianList[index];
