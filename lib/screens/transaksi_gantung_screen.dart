...
class TransaksiGantungScreen extends StatefulWidget {
  final String search;
  const TransaksiGantungScreen({super.key, this.search = ''});

  @override
  State<TransaksiGantungScreen> createState() => _TransaksiGantungScreenState();
}

class _TransaksiGantungScreenState extends State<TransaksiGantungScreen> {
  String? username, email, nama;
  int userId = 0;
  List<dynamic> transaksiGantungList = [];
  bool isLoading = true;
  String? errorMsg;
  int page = 1;
  int totalPages = 1;
  ...
  Future<void> _fetchTransaksiGantung() async {
    ...
    try {
      final result = await ApiService.transaksiGantung(
        userId: userId,
                ...
                if (isLoading)
                  ...
                  Padding(
                    ...
                    child: Align(
                      ...
                      child: Text(
                        'Transaksi Gantung (Belum Diselesaikan)',
                        style: const TextStyle(fontWeight: FontWeight.bold),
                      ),
                    ),
                  ),
                  transaksiGantungList.isEmpty
                  ...
                  Expanded(
                    child: (transaksiGantungList.isEmpty)
                        ? Center(
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: const Text(
                                    'Tidak ada data transaksi gantung',
                                    style: TextStyle(
                                      color: AppColors.textblack,
                                      fontSize: 16,
                                      fontWeight: FontWeight.bold,
